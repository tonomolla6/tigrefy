...
/**
 * Modal base reutilizable en toda la app (admin, confirmación, listas, etc).
 *
 * Características:
 *   - Backdrop click + ESC cierran (a menos que loading=true)
 ...
 *   - En desktop: centrado, max-width configurable (sm/md/lg/xl)
 *   - Variante destructive: botón submit en rojo
 *   - hideFooter: oculta los botones (modo solo body)
 *   - Animaciones suaves
 */
