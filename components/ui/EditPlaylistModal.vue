        ...
        >
          ...
          >
            ...
            <div class="p-4 md:p-6 border-b border-gray-700">
              <h2 class="text-xl md:text-2xl font-bold">Editar Playlist</h2>
              <p class="text-secondary mt-1 text-sm md:text-base">Modifica los detalles de tu playlist</p>
            </div>
            ...
            <div class="p-4 md:p-6 space-y-4 md:space-y-5">
              ...
              <div v-if="showingCoverPicker" class="space-y-3">
                ...
                <div class="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-3">
                  <button
                    ...
                    :key="cover"
                    @click="editedCover = cover; showingCoverPicker = false"
              ...
              <div>
                ...
                <input
                  ...
                  ref="nameInput"
                />
                <p class="text-xs text-secondary mt-1">{{ editedName.length }}/50 caracteres</p>
              </div>
              ...
              <div>
                ...
                ></textarea>
                <p class="text-xs text-secondary mt-1">{{ editedDescription.length }}/200 caracteres</p>
              </div>
            </div>
...
const emit = defineEmits<{
  close: []
  save: [playlistId: string, updates: { name: string; description: string; cover: string }]
}>()
...
watch(() => props.isOpen, (newVal) => {
  if (newVal) {
    ...
    editedCover.value = props.currentCover
